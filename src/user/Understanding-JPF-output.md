There are three different ways a JPF run can produce output, each of them with a different purpose, but all controlled by the [general JPF configuration mechanism](../user/Configuring-JPF.md):
...
If you develop your own JPF classes, please also check the [JPF logging API](../devel/Logging-system.md) page.
...
Again, there is separate [report system API](../devel/Reporting-System.md) documentation if you are interested in JPF development.
